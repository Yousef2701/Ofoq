...
namespace IShcool.Repository
{
    public class EnrollmentRepository : IEnrollmentRepository
    {
        ...
        public async Task<IEnumerable<The_Top_App.Models.Teacher>> GitEnrollmentTeachers(string studentId)
        {
            if(studentId != null)
            {
                var enrollTeachersId = _context.Enrollments.Where(m => m.StudentId == studentId).ToList();
                List<The_Top_App.Models.Teacher> teachers = new List<The_Top_App.Models.Teacher>();
